...
- Preserve pre-existing user documents unless their owner authorizes removal. Remove only task-created scratch, temporary handoff, or completed plan files whose useful information has already been retained; do not keep a fourth long-lived source of truth beside `active/`, `design/`, and `worklog/`.
